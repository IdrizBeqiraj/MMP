...
<body>
        <nav class="navbar navbar-collapse" id="navbarNav">
            < class="container">
                ...
                <button class="navbar-toggler" type="button" data-bs-toogle="collapse" data-bs-toogle="#navbarNav"  aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
                ...
                <?php if(!isset($_SESSION['user_id'])): ?>
                    ...
                    <?php else: ?>
                        ...
                        <div class="container mt-5">
                            ...
                            <p>This is Movie Booking Sytsem</p>
                        </div>
